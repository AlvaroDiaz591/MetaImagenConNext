...
import styles from "./AudioVolumeSlider.module.css";
...
const AudioVolumeSlider = ({ muted, onToggleMute, disabled = false }: AudioVolumeSliderProps) => {
  const showWaves = !muted;

  return (
    <div className={styles.wrapper}>
      <button
        type="button"
        className={`${styles.iconButton} ${muted ? styles.isMuted : ""}`}
      ...
      >
        ...
        >
          ...
          {muted ? <path d="M22 9.41 20.59 8 18 10.59 15.41 8 14 9.41 16.59 12 14 14.59 15.41 16 18 13.41 20.59 16 22 14.59 19.41 12z" /> : null}
        </svg>
      </button>
    </div>
  );
